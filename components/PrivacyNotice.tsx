          ...
          <div className="flex items-start gap-3 p-4 bg-blue-50 border border-blue-200 rounded-lg">
            ...
            <div>
              ...
              <p className="text-blue-800 text-sm mb-2">
                Because data never leaves your device until you download your submission package and submit it as your instructor has told you to,
          ...
          <div className="flex items-start gap-3 p-4 bg-amber-50 border border-amber-200 rounded-lg">
            ...
            <div>
              ...
              <ul className="text-amber-800 text-sm space-y-1 list-disc list-inside">
                ...
                <li>Download your submission package and submit it as your instructor has told you to, before the deadline</li>
              </ul>
            </div>
          </div>
